...
<section class="hoc container clear">
    	...
    	<div class="t_style">
                    ...
                    <p><button type="submit" class="btn btn-default">검색</button></p>
                </div>
...
<div class="row">
	<div class='list-group gallery'>
		<div class="col-md-3">
			<a class="thumbnail" href="#" rel="ligthbox"><img class="img-responsive" src="http://placehold.it/320x320"></a>
			</div>
		<div class="col-md-3">
			<a class="fancybox thumbnail" href="#" rel="ligthbox"><img class="img-responsive" src="http://placehold.it/320x320"></a>
		</div>
		<div class="col-md-3">
			<a class="fancybox thumbnail" href="#" rel="ligthbox"><img class="img-responsive" src="http://placehold.it/320x320"></a>
		</div>
...
<jsp:include page="moseover.jsp" flush="false"/> 
    ...
    <li>
      <a href="#" aria-label="Next">
        ...
        <div class="content-section text-center">
         <button class="btn btn-hero btn-lg" onClick="location.href='fingermainFirst.jsp?nav=g_write.jsp'">글쓰기</button> 
         </div>  
      </section>
